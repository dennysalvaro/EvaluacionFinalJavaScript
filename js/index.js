var calculadora = {
  ...
  asignarEventosaFuncion: function(){
    ...
    document.getElementById("dividido").addEventListener("click", function() {calculadora.verResultado("/");});
    document.getElementById("por").addEventListener("click", function() {calculadora.verResultado("*");});
    document.getElementById("menos").addEventListener("click", function() {calculadora.verResultado("-");});
    document.getElementById("mas").addEventListener("click", function() {calculadora.verResultado("+");});
  },
  ...
  cambiarSigno: function(){
	...
	verResultado: function(){
		...
		} else {  //siguientes veces que presiono igual realizar operacion
			//Calculo el Resultado
		...
		//borra el visor y lo reemplazo por el resultado
		this.valorVisor = "";
		...
		//Auxiliar para indicar si ya se presiono la tecla igual, para clacular sobre el ultimo valor
